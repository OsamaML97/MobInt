...
public class EventWindow extends Form {
    Form current;
        ...
        public EventWindow(Resources theme) {
        ...
        btnEvent2.addActionListener(e-> new AddEventsForm(theme).show());
        btnListEvent2.addActionListener(e-> new ListEventsForm(theme).show());
        cherchListEvent2.addActionListener(e-> new CherchEventForm(theme).show());
