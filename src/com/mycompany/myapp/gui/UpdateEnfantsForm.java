 ...
 * @author OsamaML97
 */
public class UpdateEnfantsForm extends Form{
    
        public UpdateEnfantsForm(Resources theme) {
        setTitle("update child");
        ...
        Button btnValider = new Button("update child");
        String f ="f";
        String m ="m";
        String datez ="20";
        String t ="-";
...
Dialog.show("Alert", "m for male / f for female", new Command("OK"));
                 ...
                 Dialog.show("Alert", "incorrect form , date in y-m-d", new Command("OK"));}
                    ...
                    try {
                        ...
                        { Dialog.show("Success","Child updated !",new Command("OK"));
